...
#
# Script generated by Vivado on Tue Feb 27 15:46:22 +0530 2024
...
#
# Usage        : read_test.sh
#                read_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                read_test.sh [-reset_run]
#                read_test.sh [-reset_log]
#                read_test.sh [-help]
#
...
# script info
echo -e "read_test.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./read_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot read_test xil_defaultlib.read_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim read_test -key {Behavioral:sim_1:Functional:read_test} -tclbatch cmd.tcl -protoinst "protoinst_files/read_test.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/intern/vivado/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb read_test.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./read_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: read_test.sh [-help]\n\
Usage: read_test.sh [-step]\n\
Usage: read_test.sh [-lib_map_path]\n\
Usage: read_test.sh [-reset_run]\n\
Usage: read_test.sh [-reset_log]\n\
Usage: read_test.sh [-keep_index]\n\
Usage: read_test.sh [-noclean_files]\n\n\
